...
TMP_DIR_PATH = os.getenv("XDG_RUNTIME_DIR") or "/tmp"
CONFIG_PATHS = {
	os.getenv("STATSCORED_CONFIG") or (HOME_DIR_PATH .. "/.config/statscored.lua"),
	"/etc/statscored.lua",
}
...
local function load_config(paths)
	...
	return {
		tick_period = table.get_in(res, "tick_period") or DEFAULT_CONFIG.tick_period,
		tick_multipliers = {
